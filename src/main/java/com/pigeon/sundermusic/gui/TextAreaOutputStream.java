...
public TextAreaOutputStream(JTextArea txtara, int maxlin) {
    if(maxlin<1) { throw new IllegalArgumentException("Максимальное количество строк TextAreaOutputStream должно быть положительным (value="+maxlin+")"); }
    oneByte=new byte[1];
    appender=new Appender(txtara,maxlin);
    }

/** Очистить текущую текстовую область консоли. */
