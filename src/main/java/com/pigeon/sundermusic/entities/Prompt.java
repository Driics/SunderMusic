...
package com.pigeon.sundermusic.entities;
...
public class Prompt
{
    ...
    {
        this.title = title;
        this.noguiMessage = noguiMessage == null ? "Переключение в режим nogui. Вы можете вручную запустить в режиме nogui, включив флаг -Dnogui=true." : noguiMessage;
        this.nogui = nogui;
    }
